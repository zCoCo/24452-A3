...
function rect_q2()
    ...
    [wn, z] = multi_logdec(root, "2.1.1", "test1", [1,2,6], "2.1.3", "test2", [1,2,6]); % Returns Experimental Results
    ...
    res = struct(); % Results
    res.mb = (m2*wn(2)^2 - m1*wn(1)^2) / (wn(1)^2 - wn(2)^2); % Remaining Unknown mass
